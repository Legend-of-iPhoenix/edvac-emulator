...
impl Word {
    ...
    pub fn with_bits(value: u64) -> Word {
        Word {
            rep: value,
...
mod tests {
    ...
    fn overflowing_div() {
        let cases: [((Word, Word), (Word, Word, bool)); 2] = [
            (
                (
                    Word::with_bits(0b00110000000000000000000000000000000000000000),
                    Word::with_bits(0b10100000000000000000000000000000000000000000),
                ),
                (
                    Word::with_bits(0b01001100110011001100110011001100110011001100),
                    Word::with_bits(0b01100110011001100110011001100110011001100110),
                    false,
                ),
            ),
            (
                (
                    Word::with_bits(0b00100000000000000000000000000000000000000000),
                    Word::with_bits(0b10100000000000000000000000000000000000000000),
                ),
                (
                    Word::with_bits(0b00110011001100110011001100110011001100110010),
                    Word::with_bits(0b10011001100110011001100110011001100110011000),
                    false,
                ),
            ),
        ];
